...
ATmega328P
  ...
  PD2          ◄──  Send button        (pull-up, active-low)
...
| Temp b1 | PD5 | D5 | in | |
| Temp b2 | PD6 | D6 | in | |
| Send button | PD2 | D2 | in | INT0 — external interrupt for wake |
...
free and were arranged around it (Send moved to PD2/INT0, Temp lines to PD4–PD6).
...
**Send** (PD2 / INT0) — push button, triggers IR transmission.
