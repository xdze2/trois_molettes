...
# ///
"""Capture serial output from the ir_rx_dump sketch.
...
Usage:
    uv run sketches/ir_rx_dump/capture.py /dev/cu.usbserial-10
    uv run sketches/ir_rx_dump/capture.py /dev/cu.usbserial-10 -o dump.txt
"""
