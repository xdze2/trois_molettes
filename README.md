...
| [01_technical_design.md](01_technical_design.md) | Implementation choices: IR, MCU, inputs, power, sleep strategy |
...
| [04_rotary_switch_choice.md](04_rotary_switch_choice.md) | Rotary switch families compared, ADC ladder readout, wake detection options |
...
- **Inputs:** 3 rotary selectors (2-pole) + 4 tactile buttons
- **Rotary readout:** resistor ladder on ADC (pole 1) · wake-from-sleep edge detection (pole 2)
- **Feedback:** single TX indicator LED (WS2812B chain optional)
- **Power:** Li-Po 3.7 V · TP4056 USB-C charging module · deep sleep between transmissions (6-month battery target)
- **BOM cost:** < €35
