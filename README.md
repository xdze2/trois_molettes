...
- **Rotary readout:** resistor ladder on gated 3.3 V ADC rail (pole 1) · alternating-contact wake-from-sleep edge (pole 2)
- **Feedback:** single TX indicator LED (knob positions are the state)
- **Power:** Li-Po 3.7 V · TP4056 USB-C charging module · deep sleep between transmissions, ladder rail gated off (6-month battery target — bench-validation pending)
- **BOM cost:** < €35
