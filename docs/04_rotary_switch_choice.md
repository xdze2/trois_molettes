...
| Temperature (SR16) | 3 | PD4 PD5 PD6 |
| Send button | 1 | PD2 |
| Swing toggle (opt.) | 1 | PD7 |
| IR TX | 1 | PD3 (OC2B) |
| TX LED (IR flash) | 1 | PB5 |
| Feedback LED | 1 | PC3 |
| **Total** | | **14 of 23 usable** |

> **IR TX pin is fixed at PD3 (OC2B)** — this is the validated, end-to-end-working
> path in the firmware ([sketches/daikin_fan_toggle](../sketches/daikin_fan_toggle));
> the carrier is generated by Timer2 toggling OC2B. The other assignments are free
> and were arranged around it.
