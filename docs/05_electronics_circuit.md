...
| Selector | Positions | Meaning |
|---|---|---|
| Fan speed | 8 | Off / 1–5 / Quiet / Auto |
| Mode | 5 | Fan / Cool / Heat / Dry / Auto |
| Temperature | 8 | 1 °C steps, mode-dependent range |
...
The v1 selectors below are plain 1-pole (1P) switches with no coded output, read by
per-switch diode encoding (§3). Chosen on body size and detent feel; pole count is not
a constraint.
